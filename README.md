...
一个参考 `VLA-Adapter / VLA-Adapter-Pro` 思路写的小型 Prismatic 风格框架。它不复制完整官方训练工程，而是把核心过程抽象成清晰的三段：
...
cfg = AdapterConfig(
    ...
    policy=PolicyConfig(hidden_size=4096, num_layers=32, action_dim=7, action_horizon=8),
